        ...
        if(this.props.notification.type === 'NewComment'){
                ...
                <div className="notification-container">
                    <button className="notification-clear-button" onClick={this.handleClearNotification}>
                        <div className="notification-info">
                            <Link to={`/posts/comments/${this.props.notification.comment._id}`} className="notification-link">{this.props.notification.message} <span className="notification-post-title">{this.props.notification.postTitle}</span></Link>
                        </div>
                    </button>               
            ...
            return (
                <div className="notification-container">
                    <button className="notification-clear-button" onClick={this.handleClearNotification}>
                        <div className="notification-info">
                            <Link to={`/posts/comments/${this.props.notification.comment.post}`} className="notification-link">{this.props.notification.message} <span className="notification-post-title">{this.props.notification.postTitle}</span></Link>               
                        </div>
                    </button>
                    <div className="notification-info content">
                        <p>{this.props.notification.comment.body}</p>
